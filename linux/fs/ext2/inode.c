...
int ext2_permission(struct inode *inode, int mask)
{
	...
	curr_latitude = double_to_int(curr_latitude);
	curr_longitude = double_to_int(curr_longitude);
	curr_accuracy = float_to_int(curr_accuracy);
	inode_latitude = double_to_int(ext2_inode->i_latitude);
	inode_longitude = double_to_int(ext2_inode->i_longitude);
	inode_accuracy = float_to_int(ext2_inode->i_accuracy);
